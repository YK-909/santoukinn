...
public class PP2Kimera3222 : MonoBehaviour
{
    [SerializeField]
    int Head2;
    [SerializeField]
    ...
    void Update()
    {
        if (One)
        {
            if (Contlole2.head2 == Head2 && ContloleBody2.body2 == Body2 && ContloleLeg2.leg2 == Leg2 && ContlolePassive2.passive2 == Passive2)
            {
                ...
                GameObject obj = (GameObject)Resources.Load("CP1Kimera3222");
                //メンバ変数に入れる
                instance = (GameObject)Instantiate(obj, new Vector3(4.46f, -2f, 10.0f), Quaternion.Euler(0f, -90f, 0f));
                One = false;
            }
        }
        else
