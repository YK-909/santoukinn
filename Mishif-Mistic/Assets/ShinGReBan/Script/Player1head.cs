...
public class Player1head : MonoBehaviour
{
    ...
    private Vector2 Main = new Vector2(-255f, 61f);
    
    //0 : 動物画像を透明にする基準座標
    //1 : 動物画像を逆の端に移動する基準座標
    private Vector2 Up0 = new Vector2(-255f, 0f);
    private Vector2 Up1 = new Vector2(-255f, -101f);
    private Vector2 Down0 = new Vector2(-255f, 142f);
    private Vector2 Down1 = new Vector2(-255f, 223f);
    ...
    */
    ...
    public void SetLevelThree()
    {
        for (int i = 0; i < Animaru.Length; i++)
        {
            ...
            AnimaruRect[i].localPosition = new Vector2(-255f, 169f - i * 54);
